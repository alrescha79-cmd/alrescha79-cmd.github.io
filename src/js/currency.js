...
function getExchangeRate(){
    ...
    var myHeaders = new Headers();
        myHeaders.append("apikey", "EP8bMfXJI0XmDbQz8q7n2M9m6UJRYFw1");
...
fetch("https://api.apilayer.com/exchangerates_data/convert?to=IDR&from=EUR&amount=1", requestOptions)
